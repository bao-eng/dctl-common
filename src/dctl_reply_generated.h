...
#ifndef FLATBUFFERS_GENERATED_DCTLREPLY_DCTL_FLAT_REPLY_H_
#define FLATBUFFERS_GENERATED_DCTLREPLY_DCTL_FLAT_REPLY_H_

#include "flatbuffers/flatbuffers.h"

namespace dctl {
namespace flat_reply {
...
struct Reply FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const dctl::flat_reply::Settings *settings() const {
    return GetStruct<const dctl::flat_reply::Settings *>(VT_SETTINGS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint32_t>(verifier, VT_PLAYER_ID) &&
           VerifyField<dctl::flat_reply::Settings>(verifier, VT_SETTINGS) &&
           verifier.EndTable();
  }
};
...
struct ReplyBuilder {
  ...
  void add_settings(const dctl::flat_reply::Settings *settings) {
...
inline flatbuffers::Offset<Reply> CreateReply(
    ...
    const dctl::flat_reply::Settings *settings = 0) {
...
inline const dctl::flat_reply::Reply *GetReply(const void *buf) {
  return flatbuffers::GetRoot<dctl::flat_reply::Reply>(buf);
}

inline const dctl::flat_reply::Reply *GetSizePrefixedReply(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<dctl::flat_reply::Reply>(buf);
}
...
inline bool VerifyReplyBuffer(
  ...
  return verifier.VerifyBuffer<dctl::flat_reply::Reply>(ReplyIdentifier());
}

inline bool VerifySizePrefixedReplyBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<dctl::flat_reply::Reply>(ReplyIdentifier());
}
...
inline void FinishReplyBuffer(
    ...
    flatbuffers::Offset<dctl::flat_reply::Reply> root) {
...
#endif  // FLATBUFFERS_GENERATED_DCTLREPLY_DCTL_FLAT_REPLY_H_
